...
public class AudioControllerNotification {
	private Activity cordovaActivity;
	private NotificationManager notificationManager;
	private Notification.Builder notificationBuilder;
	private int notificationID;
	private AudioControllerInfos infos;
	private Bitmap bitmapCover;

	// Public Constructor
	public AudioControllerNotification(Activity cordovaActivity,int id){
	...
	public void updateNotification(AudioControllerInfos newInfos){
	...
	private void createBuilder(){
		...
		if (infos.hasClose){
			nbControls++;
			Intent destroyIntent = new Intent("destroy");
